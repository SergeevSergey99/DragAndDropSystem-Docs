...
```text
ContainerDemoManager.Items <-> PlayerContainerInventoryDataBinding <-> Player Inventory UI
Context Menu / Open Container -> ContainerUIController -> ContainerInventoryDataBinding <-> Container Inventory UI
```
