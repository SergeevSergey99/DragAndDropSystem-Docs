...
позиции по смещению захвата. Подбор жадный, попредметный, без бэктрекинга. Крупные footprint
вытеснений разрешаются раньше мелких; primary placement переносится в начало только в callback payload,
поэтому клетка под курсором не влияет на порядок захвата освобождаемой области.
