...
1. Planner решает, что обычное размещение невозможно, и помечает запись как `RequiresSwap`.
2. Executor валидирует оба направления на предварительно сконвертированных стеках со стороны цели.
