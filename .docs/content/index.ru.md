...
В системе предусмотрено множество точек расширеня, благодаря этому систему можно постепенно наращивать:
...
- `DataBinding` нужно определить чтобы корректно редактировал данные в соответсвии с изменениями в UI
...
- Пример предметов сложной формы
