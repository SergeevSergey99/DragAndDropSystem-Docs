...
- отображенние данных в UI инвентаря
...
Это не просто набор UI-слотов, а система, которая, в отличае от многих альтернативных решений, которые требуют чтобы ваши данные соответствовали определенному типу, позволяет визуализировать в инвентаре практически любые ваши данные:
